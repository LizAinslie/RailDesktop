...
var System_1 = __importDefault(require("./utils/System"));
        ...
        this.ws.on('connection', function (socket) {
            ...
            setInterval(function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_g) {
                    switch (_g.label) {
                        case 0:
                            if (!(socket.readyState == 1)) return [3 /*break*/, 2];
                            _b = (_a = socket).send;
                            ...
                            return [4 /*yield*/, System_1.default.hasInternet()];
                        case 1:
                            _b.apply(_a, [_d.apply(_c, [(_e.data = (_f.hasInternet = _g.sent(),
                                        _f),
                                        _e)])]);
                            _g.label = 2;
